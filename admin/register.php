...
<main class="form-signin">
  ...
  <h3 class="mb-5 fw-bolder" >RESPONDER RESCUER</h3>
    ...
    <form method="post">
        ...
        <button class="btn btn-primary btn-lg btn-block" name="submit">register</button>
    </form>
    ...
    <p class="small fw-bold mt-2 pt-1 mb-0"><a href="index.php" class="link-light ">Sign In</a></p>
